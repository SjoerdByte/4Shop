...
@section('content')
	...
	<form action="{{ route('admin.orders.mail.send') }}" method="POST">
		...
		<textarea name="pickup" id="" cols="30" rows="5" class="form-control">De bestelling is op te halen op het 4Shop gebouw, bij voorkeur aanstaande zaterdag om 12.00u. Daarna iedere zaterdag voor of na de opkomst. Vraag er even naar bij je speltakleiding!</textarea>
